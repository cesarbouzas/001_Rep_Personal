...
public class FilmService {
	...
	public Collection<Film> findByAnyGenres(String...genres ){
		return queryService.anyGenre(genres).exec();
	}
	public Collection<Film> findByYear(String year){
		return queryService.year(year).exec();
	}
	public Collection<Film> findBetweenYear(String from, String to){
		return queryService.betweenYear(from, to).exec();
