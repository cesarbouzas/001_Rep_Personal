...
class ServidorHTTP {
  private static Socket socCliente;
    private static HiloServerHttp hiloServidor;
  /**
   * **************************************************************************
  ...
  public static void main(String[] args) throws IOException, Exception {
    ...
    while (true) {
      ...
      HiloServerHttp hiloServerHttp=new HiloServerHttp(socCliente);
      hiloServerHttp.start();
      //socCliente.close();Lo cierra el hilo 
      //System.out.println("cliente atendido");lo publica el hilo
    }
  }
